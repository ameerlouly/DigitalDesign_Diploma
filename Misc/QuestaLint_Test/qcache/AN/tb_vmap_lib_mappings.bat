...
copy D:/Github/DigitalDesign_Diploma/Misc/QuestaLint_Test/qcache/AN/modelsim.ini .
...
rem %vlib_exec% F:/QFT_2021.1/QFT_2021.1/QFT/V2021.1/win64/bin/D:/Github/DigitalDesign_Diploma/Misc/QuestaLint_Test/qcache/AN/zin_vopt_work
if %errorlevel% EQU 0 ( 
  %vmap_exec% -modelsimini modelsim.ini z0in_work_ctrl F:/QFT_2021.1/QFT_2021.1/QFT/V2021.1/win64/bin/D:/Github/DigitalDesign_Diploma/Misc/QuestaLint_Test/qcache/AN/zin_vopt_work
) else (
  echo "** Error: Library mapping failed. (Command: 'vlib F:/QFT_2021.1/QFT_2021.1/QFT/V2021.1/win64/bin/D:/Github/DigitalDesign_Diploma/Misc/QuestaLint_Test/qcache/AN/zin_vopt_work')"
)
