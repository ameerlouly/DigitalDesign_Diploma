...
clear settings -all
clear directives
#configure output directory  D:/Github/DigitalDesign_Diploma/Misc/QuestaLint_Test
clear settings  -lib
#configure output directory  D:/Github/DigitalDesign_Diploma/Misc/QuestaLint_Test
#clear directives 
...
lint generate goal  -goal Test_Goal -methodology soc -apply
set qsDebug { lint_gui_mode } 
# 
# Questa Static Verification System
# Version 2021.1 4558100 win64 28-Jan-2021
...
lint report check -severity error var_read_not_set 
lint report check -severity warning while_loop_iteration_limit 
lint methodology soc -goal Test_Goal 
lint run -d ALU -L work
set qsDebug { lint_gui_mode } 
# 
# Questa Static Verification System
# Version 2021.1 4558100 win64 28-Jan-2021
