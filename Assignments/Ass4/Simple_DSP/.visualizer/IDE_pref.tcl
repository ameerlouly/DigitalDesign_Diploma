...
set perspective_DateTime   {2025-08-09T21:48:32}
set perspective_Directory  {D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/Simple_DSP}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zinflownavigator,source,transcript,zinlintMsgView,zinlintDesignMetricsView,zinlintMsgStatusHistoryView,zinschematicview,zinlintDesignInfoView,zinlintMsgSummaryView,zinlintMsgDashboardView,zinmsgviewer,zincdcdutview -hide -description none -label none
...
pref::set -type string -category Lint -name msgViewDefaultOrderWidth -value Severity:791,Type:791,Phase:309,Message:1010,Comment:100,Status:100,Owner:100,Reviewer:100,File:100,Line:100 -hide -description none -label none
