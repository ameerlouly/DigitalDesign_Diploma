...
HD_PWD='D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/Simple_DSP/DSP_Simple/DSP_Simple.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_dsp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_dsp.tcl
