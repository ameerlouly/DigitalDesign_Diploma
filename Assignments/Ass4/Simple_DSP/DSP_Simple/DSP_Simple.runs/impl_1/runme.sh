...
HD_PWD='D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/Simple_DSP/DSP_Simple/DSP_Simple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_dsp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_dsp.tcl -notrace
