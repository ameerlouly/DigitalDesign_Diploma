...
HD_PWD='D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/ALSU/ALSU/ALSU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alsu_seq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alsu_seq.tcl -notrace
