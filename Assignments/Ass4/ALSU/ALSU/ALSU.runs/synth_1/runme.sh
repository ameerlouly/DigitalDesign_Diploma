...
HD_PWD='D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/ALSU/ALSU/ALSU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alsu_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alsu_seq.tcl
