...
HD_PWD='D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/Time_Mux/Mux_timer/Mux_timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log time_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source time_mux.tcl
