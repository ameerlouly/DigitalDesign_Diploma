...
HD_PWD='D:/GitHub/DigitalDesign_Diploma/Assignments/Ass4/Time_Mux/Mux_timer/Mux_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log time_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source time_mux.tcl -notrace
