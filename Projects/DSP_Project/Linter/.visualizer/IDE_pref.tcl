...
set perspective_DateTime   {2025-08-04T19:42:00}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zincdcdutview,zinlintMsgDashboardView,zinflownavigator,zinmsgviewer,source,zinlintMsgStatusHistoryView,zinlintMsgSummaryView,zinlintDesignInfoView,transcript,zinschematicview,zinlintMsgView,zinlintDesignMetricsView -hide -description none -label none
